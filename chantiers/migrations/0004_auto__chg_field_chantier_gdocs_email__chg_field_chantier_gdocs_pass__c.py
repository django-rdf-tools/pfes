...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('chantiers_chantier', 'gdocs_email', self.gf('django.db.models.fields.CharField')(max_length=40))

        # Changing field 'Chantier.gdocs_pass'
        db.alter_column('chantiers_chantier', 'gdocs_pass', self.gf('django.db.models.fields.CharField')(max_length=40))

        # Changing field 'Chantier.gdocs_folder'
        db.alter_column('chantiers_chantier', 'gdocs_folder', self.gf('django.db.models.fields.CharField')(max_length=40))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Chantier.gdocs_folder'
        db.alter_column('chantiers_chantier', 'gdocs_folder', self.gf('django.db.models.fields.CharField')(max_length=120))
    ...
    models = {
        'chantiers.chantier': {
            ...
            'gdocs_email': ('django.db.models.fields.CharField', [], {'max_length': '40', 'blank': 'True'}),
            'gdocs_folder': ('django.db.models.fields.CharField', [], {'max_length': '40', 'blank': 'True'}),
            'gdocs_pass': ('django.db.models.fields.CharField', [], {'max_length': '40', 'blank': 'True'}),
