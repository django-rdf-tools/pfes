...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Chantier.gdocs_folder'
        db.add_column('chantiers_chantier', 'gdocs_folder', self.gf('django.db.models.fields.CharField')(default='', max_length=120, blank=True), keep_default=False)

        # Changing field 'Chantier.gdocs_email'
        db.alter_column('chantiers_chantier', 'gdocs_email', self.gf('django.db.models.fields.CharField')(max_length=120))

        # Changing field 'Chantier.gdocs_pass'
        db.alter_column('chantiers_chantier', 'gdocs_pass', self.gf('django.db.models.fields.CharField')(max_length=120))


    def backwards(self, orm):
        
        # Adding field 'Chantier.gdocs_foler'
        db.add_column('chantiers_chantier', 'gdocs_foler', self.gf('django.db.models.fields.TextField')(default=0, blank=True), keep_default=False)

        # Deleting field 'Chantier.gdocs_folder'
        db.delete_column('chantiers_chantier', 'gdocs_folder')

        # Changing field 'Chantier.gdocs_email'
        db.alter_column('chantiers_chantier', 'gdocs_email', self.gf('django.db.models.fields.TextField')())

        # Changing field 'Chantier.gdocs_pass'
        db.alter_column('chantiers_chantier', 'gdocs_pass', self.gf('django.db.models.fields.TextField')())
    ...
    models = {
        'chantiers.chantier': {
            ...
            'gdocs_email': ('django.db.models.fields.CharField', [], {'max_length': '120', 'blank': 'True'}),
            'gdocs_folder': ('django.db.models.fields.CharField', [], {'max_length': '120', 'blank': 'True'}),
            'gdocs_pass': ('django.db.models.fields.CharField', [], {'max_length': '120', 'blank': 'True'}),
